// scv-api.ts - API client pour SCV Maker (port 8001)

const API_URL = process.env.NEXT_PUBLIC_SCV_API_URL || 'http://localhost:8001';
...
export const api = {
    ...
    async validate(data: any) {
        const res = await fetch(`${API_URL}/validate/coherence`, {
            method: 'POST',
