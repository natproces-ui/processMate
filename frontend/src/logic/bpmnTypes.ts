...
export interface TaskEnrichment {
    ...
    declencheur: string;           // Élément déclencheur de l'étape
    applicatif: string;            // Outil/application utilisé
...
export const DEFAULT_ENRICHMENTS: Map<string, TaskEnrichment> = new Map([
    ...
    ['21', {
        ...
        declencheur: '', applicatif: 'Core Banking',
